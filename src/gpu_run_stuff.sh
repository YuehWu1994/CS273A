...
train_tasks='mrpc' # cola sst mrpc
eval_tasks='all'
CLASSIFIER=mlp
...
eval ${ALLEN_CMD}
#ALLEN_CMD="python3.6 main.py --cuda 0 --random_seed 19 --no_tqdm 0 --log_file log.log --exp_dir EXP_DIR --run_dir RUN_DIR --train_tasks mrpc --eval_tasks all --classifier mlp --classifier_hid_dim 256 --max_seq_len 40 --max_word_v_size 20000 --word_embs_file ../glove/glove.6B/glove.6B.50d.txt --train_words 0 --glove 0 --elmo 1 --deep_elmo 1 --elmo_no_glove 1 --cove 0 --d_word 50 --d_hid 256 --n_layers_enc 1 --pair_enc simple --n_layers_highway 0 --batch_size 64 --bpp_method percent_tr --bpp_base 10 --optimizer sgd --lr .1 --min_lr 1e-6 --lr_decay_factor .5 --task_patience 0 --patience 20 --weight_decay 0.0 --dropout .2 --val_interval 10 --max_vals 100 --task_ordering random --weighting_method proportional --scaling_method none --scheduler_threshold 0.0 --load_model 0 --load_tasks 1 --load_preproc 1 --should_train 1 --load_epoch -1"
#eval ${ALLEN_CMD}